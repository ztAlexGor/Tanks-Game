...
class Tank():
    ...
    def __init__(self, x, y, lives = 1, cellSize = 100, width = 100, height = 100, speed = 5, direction = Direction.DOWN, player = 2, error = 0):
        self.x = x * cellSize
        self.y = y * cellSize
        self.width = width
        self.height = height
    ...
    def move(self, win, map, enemies, player):
        if self.direction == Direction.UP:
            return self.moveUp(map, enemies, player)
        elif self.direction == Direction.RIGHT:
            return self.moveRight(win, map, enemies, player)
        elif self.direction == Direction.DOWN:
            return self.moveDown(win, map, enemies, player)
        else:
            return self.moveLeft(map, enemies, player)
